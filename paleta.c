...
const pixel_t colores_ruta[4][16] = {
//   nada   nada   nada   nada   mediou mediod nada  lineas  nada   nada   nada    nada  costu  costd  nada   lineamedio
    {0xfff, 0xfff, 0x666, 0xfff, 0x666, 0x666, 0xb00, 0xfff, 0x666, 0xfff, 0xb00, 0xfff, 0xfff, 0xb00, 0xb00, 0xfff},
    {0xfff, 0xfff, 0x666, 0xfff, 0x666, 0x666, 0xfff, 0xfff, 0x666, 0xfff, 0xfff, 0xfff, 0xb00, 0xfff, 0xfff, 0xfff},
    {0x566, 0x566, 0x566, 0x566, 0x566, 0x566, 0xb00, 0xfff, 0x566, 0xfff, 0xb00, 0x566, 0xfff, 0xb00, 0xb00, 0x566},
    {0x566, 0x566, 0x566, 0x566, 0x566, 0x566, 0xfff, 0xfff, 0x566, 0xfff, 0xfff, 0x566, 0xb00, 0xfff, 0xfff, 0x566},
    //                               /      /            /                                  /       /           / 
};
/*
const pixel_t colores_ruta[4][4] = {
    // columnas: Asfalto, líneas laterales, color lateral, franja del medio
    {0x666, 0xffe, 0xb00, 0xffe},
    {0x666, 0xffe, 0xffe, 0xffe},
    {0x566, 0xffe, 0xb00, 0x566},
    {0x566, 0xffe, 0xffe, 0x566}
};
*/
