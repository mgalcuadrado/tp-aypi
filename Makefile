...
main.o: main.c imagen.h pixel.h fondo.h paleta.h teselas.h figuras.h moto.h
	$(CC) $(CFLAGS) main.c $(LFLAGS)

moto.c: moto.c moto.h
	$(CC) $(CFLAGS) moto.c

pixeles: pixel.o imagen.o paleta.o fondo.o teselas.o figuras.o moto.o main.o 
	$(CC) pixel.o imagen.o paleta.o fondo.o teselas.o figuras.o moto.o main.o -o pixeles  $(LFLAGS)
